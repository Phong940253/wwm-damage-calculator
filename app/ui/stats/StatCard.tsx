      ...
      <CardContent className="p-4 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="col-span-2 space-y-1">
            <div className="text-[11px] text-muted-foreground">{t("stats.statTotal")}</div>
            <Input
          ...
          <div className="col-span-1 space-y-1">
            <div className="text-[11px] text-muted-foreground">{t("stats.statIncrease")}</div>
            <Input
              type="number"
              value={
